...
public partial class MembersForm : Window
{
    ...
    private void ShowTable(string sql)
    {
        ...
        while (reader.Read() && reader.HasRows)
        {
            var currentMembers = new Members()
            {
                ...
                Squad_Name = reader.GetString("Squad_Name")
            };
    ...
    private void AddData(object? sender, RoutedEventArgs e)
    {
        ...
        RSOPredApp.AddUpdate addWindow = new AddUpdate(newMember, memberlist);
        addWindow.Show();
        this.Close();
    }
    ...
    private void EditData(object? sender, RoutedEventArgs e)
    {
        ...
        RSOPredApp.AddUpdate updateWindow = new AddUpdate(currentMember, memberlist);
        updateWindow.Show();
        this.Close();
    }
